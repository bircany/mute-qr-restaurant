        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex justify-center pb-4">
            <a 
              ...
              className="flex items-center gap-3 bg-copper-900/10 border border-copper-500/20 px-6 py-3 rounded-xl hover:bg-copper-900/20 transition-all duration-300 group backdrop-blur-sm"
            >
              <div className="w-8 h-8 rounded-full bg-[#25D366] text-white flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-green-900/20">
              ...
              <span className="text-copper-200 font-medium font-playfair tracking-wide">İleri Tarihli Rezervasyon</span>
            </a>
          </div>
          {/* Decorative Line */}
